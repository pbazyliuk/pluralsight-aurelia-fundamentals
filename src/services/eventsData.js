export var eventsData = [
	...
	},
	{
		id: 151,
		description:
			"Does your web application contain common coding mistakes that can lead to security problems? In this session, you can find out! We'll be going over common security vulnerabilities in web applications, such as XSS and CSRF, how attackers use them, and how to protect your web application from these. ",
	...
	},
	{
		...
		title:
			'Architecting for Failure, Cloud Architecture is Different! (Michael Stiefel)',
	...
	},
	{
		...
		title:
			'Supercharge your JavaScript with TypeScript - Steve Michelotti (MVP)',
	...
	},
	{
		...
		title:
			'Diversified Asp.Net - One Web Project - 4 Asp.Net Frameworks - Jeff Fritz (Telerik)',
		speaker: 'Jeff Fritz',
		image: 'JeffFritz.jpg'
	},
	{
		id: 129,
		description:
			'As a web developer today, the choices of technologies and open source libraries are overwhelming.  It’s impossible to keep up with all of them, but there is a short list that every web developer should be familiar with.  This presentation will get you started on compiling your developer ‘toolbox’.  We’ll talk about core technologies like Entity Framework, WCF Data Services as well as open source libraries such as jQuery, Knockout.js,. data.js, css frameworks, etc and how to use them to build cutting edge web projects.  ',
	...
	},
	{
		...
		title:
			'Special Event - Teach Your Kids to Code! (Bring your kids!) - Steve Michelotti (MVP)',
		speaker: 'Steve Michelotti',
		image: 'SteveMichelotti.jpg'
	},
	{
		...
		title:
			'Building Mobile apps with the Ionic framework and AngularJS - Steve Michelotti (MVP)',
		speaker: 'Steve Michelotti',
		image: 'SteveMichelotti.jpg'
	},
	{
	...
	},
	{
		id: 156,
		description:
			'At the Build 2015 conference, Microsoft unveiled the Universal Windows Platform - a single API that developers can target for building applications for desktop, mobile, Xbox, and IoT targets using the Windows 10 OS. In this talk, you will get an overview of what it means to target all these platforms through Windows 10, and a quick intro to the programming model for it. You will learn how to use XAML and C# to target desktop, tablets, and phones in Windows 10, as well as learning about the other ways of getting apps onto the platform, including using HTML/JS, wrapping Android apps, and recompiling iOS apps.',
	...
	},
	{
		...
		title:
			'Build Great Websites and Apps with Azure App Service - G. Andrew Duthie',
		speaker: 'G. Andrew Duthie',
		image: 'GAndrewDuthie.jpg'
	},
	{
	...
	},
	{
		...
		title:
			'Developing Games for the Windows Store with HTML5 and JavaScript - G. Andrew Duthie',
		speaker: 'G. Andrew Duthie',
		image: 'GAndrewDuthie.jpg'
	},
	{
	...
	},
	{
		id: 170,
		description:
			'ASP.NET 5 introduces some great new capabilities, the ability to host on multiple server platforms, and a number of new tools that you will want to get familiar with. Come join Microsoft Senior Technical Evangelist Shahed Chowdhuri at Caparea.net to learn about the future of ASP.NET 5, MVC 6 and Web API.',
	...
	},
	{
		...
		title:
			'ASP.NET Quick Wins - 20 Tips and Tricks for Better Performance - Kevin Griffin',
		speaker: 'Kevin Griffin',
